...
public class ObjectRenderer 
{
	...
	*/
	...
	public ObjectRenderer() {}//Constructor
	...
	*/
	public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName) throws IOException 
	{
		...
		this.texCoordsBaseAddress = verticesBaseAddress + 4 * vertices.limit();
		this.normalsBaseAddress = texCoordsBaseAddress + 4 * texCoords.limit();
		...
		final int vertexShader 	 = ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, "shaders/object.vert");
		final int fragmentShader = ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, "shaders/object.frag");
		...
		this.modelViewUniform = GLES20.glGetUniformLocation(program, "u_ModelView");
		this.modelViewProjectionUniform = GLES20.glGetUniformLocation(program, "u_ModelViewProjection");

		this.positionAttribute = GLES20.glGetAttribLocation(program, "a_Position");
		this.normalAttribute = GLES20.glGetAttribLocation(program, "a_Normal");
		this.texCoordAttribute = GLES20.glGetAttribLocation(program, "a_TexCoord");

		this.textureUniform = GLES20.glGetUniformLocation(program, "u_Texture");

		this.lightingParametersUniform = GLES20.glGetUniformLocation(program, "u_LightingParameters");
		this.materialParametersUniform = GLES20.glGetUniformLocation(program, "u_MaterialParameters");
		this.colorCorrectionParameterUniform = GLES20.glGetUniformLocation(program, "u_ColorCorrectionParameters");
		this.colorTintParameterUniform = GLES20.glGetUniformLocation(program, "u_ColorTintParameters");
   ...
   */
	...
	* @see android.opengl.Matrix
	*/
	public void draw(float[] cameraView, float[] cameraPerspective, float[] colorCorrectionRgba, float[] colorTintRgba) 
	{
		...
		GLES20.glUniform4f(colorCorrectionParameterUniform,colorCorrectionRgba[0], colorCorrectionRgba[1], colorCorrectionRgba[2], colorCorrectionRgba[3]);

		GLES20.glUniform4f(colorTintParameterUniform, colorTintRgba[0], colorTintRgba[1], colorTintRgba[2], colorTintRgba[3]);
